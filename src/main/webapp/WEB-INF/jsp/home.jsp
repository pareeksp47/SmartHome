...
<div class="mySlides fade">
  <img src="/smarthome/images/banner3.jpg">
...
<div class="mySlides fade">
  <img src="/smarthome/images/banner4.png">
</div>
...
<!-- multiple sensors -->
  <div class="img1">
	...
	<img src="/smarthome/images/smrt7.jpeg" align="right;" width="40%" height="250px" style="float:left; margin-left: 50px; margin-right:40px; margin-top: 10px; border: solid grey 1px; padding: 2px"/>
...
Use the ADT Pulse® app to control your smart thermostat with your mobile devices.<h3>CUSTOM ALERTS:</h3>Set up custom smart thermostat notifications to alert you if your home is too cold or too warm.</p>
  ...
  <div class="img2">
    ...
    <img src="/smarthome/images/smrt8.jpeg" align="left" width="40%" height="250px" style=" float:right;  margin-right:40px; margin-left:40px;  margin-bottom: 20px;  margin-top: 0px; border: solid black 1px; padding: 3px">
  ...
  <div class="img3">
	...
	<img src="./smarthome/images/energyconsumption.png"  align="right;" width="40%" height="250px" style="float:left; margin-left: 50px; margin-right:40px; margin-top: 0px; border: solid grey 1px; padding: 2px"/>
  ...
  <div class="img4">
    ...
    <img src="/smarthome/images/smrt16.jpg" align="left" width="40%" height="250px" style=" float:right;  margin-right:40px; margin-left:40px;  margin-bottom: 20px;  margin-top: 10px; border: solid black 1px; padding: 3px">
